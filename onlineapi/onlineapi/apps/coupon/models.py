...
class Coupon(BaseModel):
    ...
    condition = models.IntegerField(blank=True, default=0, verbose_name="满足使用的优惠券的价格条件")
    per_limit = models.SmallIntegerField(default=1, verbose_name="每个人限制领取数量")
...
class CouponDirection(models.Model):
    ...
    class Meta:
        db_table = "ol_coupon_course_direction"
...
class CouponCourseCat(models.Model):
    ...
    class Meta:
        db_table = "ol_coupon_course_category"
