        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "total",
                    models.IntegerField(
                        blank=True, default=100, verbose_name="发放数量"
                    ),
                ),
                (
                    "has_total",
                    models.IntegerField(
                        blank=True, default=100, verbose_name="剩余数量"
                    ),
                ),
                ...
                (
                    "condition",
                    models.IntegerField(
                        blank=True, default=0, verbose_name="满足使用的优惠券的价格条件"
                    ),
                ),
                (
                    "per_limit",
                    models.SmallIntegerField(
                        default=1, verbose_name="每个人限制领取数量"
                    ),
                ),
                (
                    "sale",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        blank=True, max_length=100, null=True, verbose_name="名称/标题"
                    ),
                ),
                (
                    "use_time",
