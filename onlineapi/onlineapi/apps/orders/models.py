...
class Order(BaseModel):
    ...
    user = models.ForeignKey(User, related_name="user_order", on_delete=models.DO_NOTHING,
...
class OrderDetail(BaseModel):
    ...
    订单详情
    """
    order = models.ForeignKey(Order, related_name='order_course', on_delete=models.DO_NOTHING,
                              db_constraint=False, verbose_name="订单")
    course = models.ForeignKey(Course, related_name="course_orders", on_delete=models.DO_NOTHING,
