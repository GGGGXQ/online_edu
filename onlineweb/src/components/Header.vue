            ...
            <div class="login-box ">
              ...
              <el-dropdown>
                <span class="el-dropdown-link">
                  <router-link  to="/user">
                  <el-avatar class="avatar" size="50" src="https://onlineeducationpro.oss-cn-beijing.aliyuncs.com/avatar.jpg"></el-avatar>
                  </router-link>
                </span>
                <template #dropdown>
                  <el-dropdown-menu>
